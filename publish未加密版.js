...
var newestUrls = [
	...
	'https://' + getRandomString() + '.dvosmhud.com',    
    'https://' + getRandomString() + '.dvosmhud.com',
    'https://' + getRandomString() + '.dupnvvmz.com',
    'https://' + getRandomString() + '.dupnvvmz.com',
    'https://' + getRandomString() + '.atzectj.net',
	'https://' + getRandomString() + '.atzectj.net',
    'https://' + getRandomString() + '.atzectj.net',
    'https://' + getRandomString() + '.atzectj.net',
    'https://' + getRandomString() + '.atzectj.net',
    'https://' + getRandomString() + '.atzectj.net',
	'https://' + getRandomString() + '.qyv6xzo.com',
    'https://' + getRandomString() + '.qyv6xzo.com',
    'https://' + getRandomString() + '.iobohakr.com',
    'https://' + getRandomString() + '.iobohakr.com'
];
var otherUrls = [
...
window.onload = function () {
    ...
    // newest urls
    var newestFieldElem = createFieldElem({title: '最新地址', items: newestUrls, text: '请使用https://协议访问sqhub'});
